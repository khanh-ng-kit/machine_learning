...
model_path = r'F:\tailieu\HOC_MAY\code\model\rice_leaf_cnn_model.h5'
print("Tồn tại file model:", os.path.exists(model_path))

# Đường dẫn file class_indices
class_indices_path = r'F:\tailieu\HOC_MAY\code\output\output\class_indices.json'
...
test_dir = r'F:\tailieu\HOC_MAY\code\rice_data_split\test'
